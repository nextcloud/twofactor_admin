OC.L10N.register(
    ...
    "Generate" : "Generálás",
    "Could not generate a code: {error}" : "Kód generálása sikertelen: {error}",
    "The generated code is {code}. It is valid for {hours} hours" : "A generált kód: {code}. {hours} óráig érvényes",
